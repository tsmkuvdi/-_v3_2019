...
try {
	...
	foreach ($result as $row) {
		...
		echo "<td>\n";
		echo "<a href=/kensa/shousai.php?id=" . htmlspecialchars($row['id_kensa'],ENT_QUOTES,'UTF-8') . " >詳細</a>\n";
		echo "</td>\n";
		echo "<td>\n";
		echo "<a href=/kensa/kensaedit.php?id=" . htmlspecialchars($row['id_kensa'],ENT_QUOTES,'UTF-8') . ">基本情報</a>\n";
